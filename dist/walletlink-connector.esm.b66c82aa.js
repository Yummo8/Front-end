...
})({"6Tuy5":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "9082a2beb66c82aa";
...
},{}],"jrUeq":[function(require,module,exports) {
...
var WalletLinkConnector = /*#__PURE__*/ function(_AbstractConnector) {
    _inheritsLoose(WalletLinkConnector1, _AbstractConnector);
    function WalletLinkConnector1(_ref) {
        var _this;
    ...
    var _proto = WalletLinkConnector1.prototype;
                ...
                _this3.provider = window.ethereum;
                    ...
                    var _temp6 = function() {
                        if (!_this3.walletLink) return Promise.resolve(res.then(function(m) {
                            ...
                            return require("d4ecb396484026ff");
    ...
    return WalletLinkConnector1;
}(_abstractConnector.AbstractConnector);

},{"@web3-react/abstract-connector":"gkcsn","d4ecb396484026ff":"luPMc","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gkcsn":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"events":"1VQLm","@web3-react/types":"5JR8V","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"luPMc":[function(require,module,exports) {
module.exports = require("./helpers/browser/js-loader")(require('./helpers/bundle-url').getBundleURL('cpdWz') + "dist.da0bee56.js" + "?" + Date.now()).catch((err)=>{
    delete module.bundle.cache[module.id];
    throw err;
}).then(()=>module.bundle.root('add7s')
);

},{"./helpers/browser/js-loader":"61B45","./helpers/bundle-url":"lgJ39"}]},["6Tuy5"], null, "parcelRequiredb79")

//# sourceMappingURL=walletlink-connector.esm.b66c82aa.js.map
