...
})({"5Z3QN":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
...
class WalletConnectProvider {
    constructor(opts){
        this.events = new _eventemitter3Default.default();
        this.rpc = {
            infuraId: opts === null || opts === void 0 ? void 0 : opts.infuraId,
            custom: opts === null || opts === void 0 ? void 0 : opts.rpc
        };
        this.signer = new _jsonrpcProvider.JsonRpcProvider(new _signerConnection.SignerConnection(opts));
    ...
    async request(args) {
        ...
        if (_utils.signingMethods.includes(args.method)) return this.signer.request(args);
    ...
    setHttpProvider(chainId) {
        const rpcUrl = _utils.getRpcUrl(chainId, this.rpc);
        if (typeof rpcUrl === "undefined") return undefined;
        const http = new _jsonrpcProvider.JsonRpcProvider(new _jsonrpcHttpConnection.HttpConnection(rpcUrl));
        return http;
    }
}
exports.default = WalletConnectProvider;

},{"eventemitter3":"bVhFu","@walletconnect/jsonrpc-provider":"6zGTK","@walletconnect/jsonrpc-http-connection":"dtBb9","@walletconnect/utils":"lXjaj","@walletconnect/signer-connection":"6KFu5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"bVhFu":[function(require,module,exports) {
'use strict';
    ...
    async requestStrict(request, context) {
        return new Promise(async (resolve, reject)=>{
            ...
            this.events.on(`${request.id}`, (response)=>{
                if (_jsonrpcUtils.isJsonRpcError(response)) reject(response.error.message);
...
exports.default = _httpDefault.default;
...
class HttpConnection {
    constructor(url){
        ...
        if (!_jsonrpcUtils.isHttpUrl(url)) throw new Error(`Provided URL is not compatible with HTTP connection: ${url}`);
        this.url = url;
    }
    get connected() {
    ...
    async send(payload, context) {
        ...
        try {
            const body = _safeJson.safeJsonStringify(payload);
            const res = await _crossFetchDefault.default(this.url, Object.assign(Object.assign({}, DEFAULT_FETCH_OPTS), {
                body
            }));
    ...
    async register(url = this.url) {
        ...
        try {
            const body = _safeJson.safeJsonStringify({
                id: 1,
                jsonrpc: "2.0",
                method: "test",
                params: []
            });
            await _crossFetchDefault.default(url, Object.assign(Object.assign({}, DEFAULT_FETCH_OPTS), {
                body
            }));
            this.onOpen();
        } catch (e) {
    ...
    parseError(e, url = this.url) {
        return _jsonrpcUtils.parseConnectionError(e, url, "HTTP");
    }
}
exports.default = HttpConnection;

},{"events":"1VQLm","cross-fetch":"kUS01","@walletconnect/safe-json":"cD1pC","@walletconnect/jsonrpc-utils":"izCJ8","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"kUS01":[function(require,module,exports) {
...
},{"bn.js":"ci636","@walletconnect/encoding":"gqnDn","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ci636":[function(require,module,exports) {
...
},{"buffer":"jhUEF"}],"gqnDn":[function(require,module,exports) {
"use strict";
...
},{"buffer":"fCgem","is-typedarray":"aCwce","typedarray-to-buffer":"2lRgC"}],"aCwce":[function(require,module,exports) {
...
},{"buffer":"fCgem","is-typedarray":"aCwce"}],"fSzyo":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"js-sha3":"7x0z6","@walletconnect/encoding":"gqnDn","./encoding":"8M9Pg","./misc":"hSD3H","./validators":"1lESp","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"hSD3H":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@walletconnect/encoding":"gqnDn","@walletconnect/jsonrpc-utils":"izCJ8","./constants":"66pHN","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1lESp":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@walletconnect/encoding":"gqnDn","./constants":"66pHN","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"bQ5xc":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"strict-uri-encode":"hU4vY","decode-uri-component":"1clyr","split-on-first":"70WYe"}],"hU4vY":[function(require,module,exports) {
'use strict';
...
var _jsonrpcTypes = require("@walletconnect/jsonrpc-types");
var _jsonrpcUtils = require("@walletconnect/jsonrpc-utils");
class SignerConnection extends _jsonrpcTypes.IJsonRpcConnection {
    constructor(opts){
        super();
        this.events = new _eventemitter3Default.default();
        this.accounts = [];
    ...
    async send(payload) {
        ...
        this.sendPayload(payload).then((res)=>this.events.emit("payload", res)
        ).catch((e)=>this.events.emit("payload", _jsonrpcUtils.formatJsonRpcError(payload.id, e.message))
        );
    }
    register(opts) {
        ...
        const connectorOpts = {
            bridge: this.bridge,
            qrcodeModal: this.qrcode ? _qrcodeModalDefault.default : undefined,
            qrcodeModalOptions: this.qrcodeModalOptions,
            storageId: opts === null || opts === void 0 ? void 0 : opts.storageId,
            signingMethods: opts === null || opts === void 0 ? void 0 : opts.signingMethods,
            clientMeta: opts === null || opts === void 0 ? void 0 : opts.clientMeta
        };
        this.wc = typeof (opts === null || opts === void 0 ? void 0 : opts.connector) !== "undefined" ? opts.connector : new _clientDefault.default(connectorOpts);
    ...
    sanitizeResponse(response) {
        return typeof response.error !== "undefined" && typeof response.error.code === "undefined" ? _jsonrpcUtils.formatJsonRpcError(response.id, response.error.message) : response;
    }
}
exports.default = SignerConnection;

},{"eventemitter3":"1gaz1","@walletconnect/client":"kphU9","@walletconnect/qrcode-modal":"hLnYZ","@walletconnect/jsonrpc-types":"TA1tb","@walletconnect/jsonrpc-utils":"izCJ8","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1gaz1":[function(require,module,exports) {
'use strict';
var has = Object.prototype.hasOwnProperty, prefix = '~';
/**
 * Constructor to create a storage for our `EE` objects.
...
},{}],"kphU9":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class Connector {
    ...
    set key(value) {
        if (!value) return;
        const key = _utils.convertHexToArrayBuffer(value);
        this._key = key;
    }
    get key() {
        if (this._key) {
    ...
    async signPersonalMessage(params) {
        if (!this._connected) throw new Error(_errors.ERROR_SESSION_DISCONNECTED);
        params = _utils.parsePersonalSign(params);
        const request = this._formatRequest({
    ...
    async sendCustomRequest(request, options) {
        ...
        switch(request.method){
            ...
            case "eth_signTransaction":
                if (request.params) request.params[0] = _utils.parseTransactionData(request.params[0]);
                break;
            case "personal_sign":
                if (request.params) request.params = _utils.parsePersonalSign(request.params);
                break;
            default:
                break;
        }
    ...
    approveRequest(response) {
        if (_utils.isJsonRpcResponseSuccess(response)) {
            const formattedResponse = this._formatResponse(response);
            this._sendResponse(formattedResponse);
        } else throw new Error(_errors.ERROR_MISSING_RESULT);
    }
    rejectRequest(response) {
        if (_utils.isJsonRpcResponseError(response)) {
            const formattedResponse = this._formatResponse(response);
            this._sendResponse(formattedResponse);
    ...
    async _sendRequest(request, options) {
        ...
        const silent = typeof (options === null || options === void 0 ? void 0 : options.forcePushNotification) !== "undefined" ? !options.forcePushNotification : _utils.isSilentPayload(callRequest);
    ...
    _formatRequest(request) {
        if (typeof request.method === "undefined") throw new Error(_errors.ERROR_MISSING_METHOD);
        const formattedRequest = {
            id: typeof request.id === "undefined" ? _utils.payloadId() : request.id,
            jsonrpc: "2.0",
    ...
    _formatResponse(response) {
        if (typeof response.id === "undefined") throw new Error(_errors.ERROR_MISSING_ID);
        const baseResponse = {
            id: response.id,
            jsonrpc: "2.0"
        };
        if (_utils.isJsonRpcResponseError(response)) {
            const error = _utils.formatRpcError(response.error);
            const errorResponse = Object.assign(Object.assign(Object.assign({}, baseResponse), response), {
                error
            });
            return errorResponse;
        } else if (_utils.isJsonRpcResponseSuccess(response)) {
    ...
    _subscribeToSessionResponse(id, errorMsg) {
        this._subscribeToResponse(id, (error, payload)=>{
            ...
            if (payload.result) this._handleSessionResponse(errorMsg, payload.result);
...
class SocketTransport {
    ...
    async _socketReceive(event1) {
        let socketMessage;
        try {
            socketMessage = JSON.parse(event1.data);
        } catch (error) {
            return;
        }
        this._socketSend({
...
},{"@walletconnect/utils":"lXjaj","./network":"kD3Pe","ws":"13N0i","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"kD3Pe":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@walletconnect/crypto":"ja9Wq","@walletconnect/encoding":"gqnDn","@walletconnect/utils":"lXjaj","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ja9Wq":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../utils/buffer":"ctzhM","./polynomial":"dxhHI","buffer":"fCgem"}],"dxhHI":[function(require,module,exports) {
var BufferUtil = require('../utils/buffer');
...
},{"../utils/buffer":"ctzhM"}],"a8ag2":[function(require,module,exports) {
var Utils = require('./utils');
var ECCode = require('./error-correction-code');
var ECLevel = require('./error-correction-level');
var Mode = require('./mode');
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["5Z3QN"], null, "parcelRequiredb79")
