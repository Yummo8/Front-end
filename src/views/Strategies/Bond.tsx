      ...
      <Page>
        ...
        <Grid item xs={12} md={12} lg={12}>
          ...
          <p style={{ fontSize: '20px', textAlign: 'center', color: '#fff' }}>
            ...
            <a target={'_blank'} href="https://grapefinance.gitbook.io/grape-finance-docs/protocol/strategies">
              docs here.
            </a>
          </p>
          ...
          <h2 style={{ textAlign: 'center', marginTop: '100px', paddingBottom: '50px' }}>
            Asgard DAO Multiplier Strategy
          </h2>
          <img src={wampStrat} width={'100%'} />
          <h2 style={{ textAlign: 'center', marginTop: '100px', paddingBottom: '50px' }}>
            Hermes Dual Rewards Pool Strategy
          </h2>
