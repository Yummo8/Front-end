        ...
        <Container>
          <Grid item xs={12} md={12} lg={12}>
            ...
            <h2 style={{ textAlign: 'center', marginTop: '60px' }}>
              Beginner tutorial on Grape staking & adding to LPs
            </h2>
            <br></br>
            ...
            <h2 style={{ textAlign: 'center', marginTop: '60px' }}>The Basics of Seigniorage Protocols</h2>
            <br></br>
            <iframe
              width="100%"
              height="550px"
            ...
            <h2 style={{ textAlign: 'center', marginTop: '60px' }}>How to stake LP tokens & Wine at Grape Finance</h2>
            <br></br>
            <iframe
              width="100%"
              height="550px"
