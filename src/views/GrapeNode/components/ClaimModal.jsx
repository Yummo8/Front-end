...
const ClaimModal = ({bank, tokenName = ''}) => {
  ...
  return (
    <Modal>
      ...
      /> 
      <center><h3>Claim {getDisplayBalance(earnings) * (claimFee === 0 ? 1 : (100 - claimFee) / 100)} {tokenName} after the {claimFee}% Fee?</h3><br /><br />With your GRAPE rewards, you can:<br /><br />1. Compound into more Nodes,<br />2. Single-stake GRAPE in the Vineyard to earn WINE,<br />3. Pair GRAPE with MIM and stake it in the Vineyard to earn WINE.</center>
      <ModalActions>
