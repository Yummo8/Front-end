          ...
          <>
            <Grid item xs={12} md={12} lg={12}>
              ...
              <p style={{ fontSize: '20px', textAlign: 'center', color: '#fff' }}>
                This isn't just your average raffle, this raffle gives you the chance to win NFTs from our awesome
                partners! Each with utility that goes into a reward pool for 3 winners to choose from! To enter simply
                click the enter raffle button below to send 5 MIM to the raffle address or manually send MIM to the
                raffle address shown below.{' '}
              </p>
              ...
              <p style={{ fontSize: '20px', textAlign: 'center', color: '#fff' }}>
                5 MIM Per Entry, Unlimited Entries Per Wallet!<br></br>3 Winners will be selected!<br></br>
                1st- Picks 3 NFTs from reward pool <br></br>
                2nd- Picks 2 NFTs from reward pool <br></br>
                3rd- Picks 1 NFT from reward pool{' '}
              </p>

              <Grid container justify="center" spacing={3} style={{ marginTop: '10px', marginBottom: '20px' }}>
                <img style={{ width: '450px' }} src={Collage} />
              </Grid>

              <p style={{ fontSize: '20px', textAlign: 'center', color: '#fff' }}>
                Many thanks to our awesome partners for donating NFTs!<br></br>
                <a target={'_blank'} href={'https://www.eltacofinance.com/'}>
                  El Taco Finance
                </a>
                <br></br>
                <a target={'_blank'} href={'https://magik.finance/'}>
                  Magik Finance
                </a>
                <br></br>
                <a target={'_blank'} href={'https://app.mvfinance.club/'}>
                  Miniverse Finance
                </a>
                <br></br>
              </p>
            ...
            {Date.now() > endTime ? (
              <h2 style={{ fontSize: '40px', textAlign: 'center' }}>Raffle Closed</h2>
            ) : (
